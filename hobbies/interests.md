  ...
  root((What I'm Into))
    ...
    Building
      Random startup ideas
        Idea backlog → quick experiments
      Solutions for my girlfriend
        arkitekto.review
      Influencer journey
        miming.io
```
...
```mermaid
flowchart LR
    A["Read<br/>(curiosity + input)"] --> B["Build<br/>(startup ideas, arkitekto.review)"]
    B --> C["Share<br/>(miming.io, build in public)"]
    C --> D["Reputation +<br/>opportunities"]
    D --> A
