...
```mermaid
flowchart TD
    A["Morning:<br/>Dichotomy of Control"] --> B["Categorize concerns into<br/>'within my control' vs 'outside my control'<br/>Focus exclusively on the first"]
    C["Throughout day:<br/>The Obstacle Is the Way"] --> D["Reframe setbacks as<br/>opportunities for growth<br/>'What stands in the way<br/>becomes the way'"]
    E["Evening:<br/>Seneca's Review"] --> F["What did I do well?<br/>Where did I fall short?<br/>What can I improve tomorrow?"]
    G["Weekly:<br/>Negative Visualization"] --> H["Imagine losing what you value<br/>Builds gratitude for what you have<br/>Builds resilience if loss occurs"]
    I["Ongoing:<br/>Voluntary Discomfort"] --> J["Cold showers, fasting, hard choices<br/>Builds resilience and reduces<br/>fear of hardship"]
    style A fill:#e94560,stroke:#e94560,color:#fff
    style C fill:#0f3460,stroke:#0f3460,color:#fff
    style E fill:#8e44ad,stroke:#8e44ad,color:#fff
    style G fill:#e67e22,stroke:#e67e22,color:#fff
    style I fill:#0a8754,stroke:#0a8754,color:#fff
```
...
flowchart LR
    ...
    subgraph evening["Evening: Reflect (Seneca's Method)"]
        direction TB
